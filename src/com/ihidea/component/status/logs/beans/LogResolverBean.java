 ...
 * PURPOSE.
 */
package com.ihidea.component.status.logs.beans;
...
import com.ihidea.component.status.logs.model.Application;
import com.ihidea.component.status.logs.model.DisconnectedLogDestination;
import com.ihidea.component.status.logs.tools.ApplicationUtils;
import com.ihidea.component.status.logs.tools.Instruments;
import com.ihidea.component.status.logs.tools.logging.FileLogAccessor;
import com.ihidea.component.status.logs.tools.logging.LogDestination;
import com.ihidea.component.status.logs.tools.logging.catalina.CatalinaLoggerAccessor;
import com.ihidea.component.status.logs.tools.logging.commons.CommonsLoggerAccessor;
import com.ihidea.component.status.logs.tools.logging.jdk.Jdk14LoggerAccessor;
import com.ihidea.component.status.logs.tools.logging.jdk.Jdk14ManagerAccessor;
import com.ihidea.component.status.logs.tools.logging.log4j.Log4JLoggerAccessor;
import com.ihidea.component.status.logs.tools.logging.log4j.Log4JManagerAccessor;
import com.ihidea.component.status.logs.tools.logging.logback.LogbackFactoryAccessor;
import com.ihidea.component.status.logs.tools.logging.logback.LogbackLoggerAccessor;
import com.ihidea.component.status.logs.tools.logging.slf4jlogback.TomcatSlf4jLogbackFactoryAccessor;
import com.ihidea.component.status.logs.tools.logging.slf4jlogback.TomcatSlf4jLogbackLoggerAccessor;
